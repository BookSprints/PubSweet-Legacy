...
var options = {
    key: fs.readFileSync('/etc/apache2/certs/pubsweet-new.key'),
    //key: fs.readFileSync('/Applications/AMPPS/apache/conf/ssl_key/localhost.key'),
    cert: fs.readFileSync('/etc/apache2/certs/pubsweet-new.crt'),
    //cert: fs.readFileSync('/Applications/AMPPS/apache/conf/ssl_crt/localhost.crt'),
    ca: fs.readFileSync('/etc/apache2/certs/my_ca.crt'),
};
