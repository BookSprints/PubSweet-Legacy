...
$config['DX_website_name'] = 'PUBSWEET';
$config['DX_webmaster_email'] = 'whan.kharlos@gmail.com';
...
$config['DX_login_uri'] = '/register/login/';
...
// Forms view
$config['DX_login_view'] = 'user/login';
//$config['DX_register_view'] = 'auth/register_form';
$config['DX_register_view'] = 'register/user';
//$config['DX_forgot_password_view'] = 'auth/forgot_password_form';
$config['DX_forgot_password_view'] = 'user/forgot_password_form';
//$config['DX_change_password_view'] = 'auth/change_password_form';
$config['DX_change_password_view'] = 'user/change_password_form';
...
$config['DX_logged_in_view'] = 'dashboard/profile';
$config['DX_logged_in_url'] = 'dashboard/profile';
$config['DX_logout_view'] = 'auth/general_message';

$config['DX_register_success_view'] = 'auth/general_message';
$config['DX_register_success_url'] = 'dashboard/profile';
$config['DX_register_success_uri'] = 'dashboard/profile';
