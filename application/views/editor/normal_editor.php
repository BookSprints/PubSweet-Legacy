        ...
        <div class="row-fluid">
            <form action="<?php echo base_url('chapter/saveContent'); ?>" method="post" id="form-save-content"
                ...
                <textarea name="content" id="editor" cols="30" rows="10" class="hide"
                          autofocus="autofocus" data-auto-save-time="<?php echo $userSettings!=null?$userSettings->autosave_time:0;?>">
                        <?php echo empty($chaptername['content']) ? '<h1>' . $chaptername['title'] . '</h1>' : str_replace('&', '&amp;', $chaptername['content']); ?></textarea>
