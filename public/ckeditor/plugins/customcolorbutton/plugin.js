...
//    lang: 'af,ar,bg,bn,bs,ca,cs,cy,da,de,el,en,en-au,en-ca,en-gb,eo,es,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
    icons: 'back.png,fore.png', // %REMOVE_LINE_CORE%
    ...
    init: function( editor ) {
        ...
        if ( !CKEDITOR.env.hc ) {
            addButton( 'CustomTextColor', 'fore', lang.textColorTitle, 10 );
            addButton( 'CustomBGColor', 'back', lang.bgColorTitle, 20 );
        }
        ...
        function addButton( name, type, title, order ) {
            ...
            editor.ui.add( name, CKEDITOR.UI_PANELBUTTON, {
                ...
                icon: 'plugins/customcolorbutton/icons/'+type+'.png',
                panel: {
